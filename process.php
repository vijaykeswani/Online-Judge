...
$yuvascript="$cur_dir/problems/".$problemID.'/yuva.sh';   	// change made here
/*
...
//Changes done here
exec("mpicc $submID".".c -o $submID",$out,$return);
if($return==0)
{
	exec("qsub $yuvascript -e ",$jobID);
	exec("qstat -r $jobID ",$status);
	if($status == 'C')
	{
